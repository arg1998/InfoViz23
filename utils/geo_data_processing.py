...
out_shapefile_path = pathlib.Path("./Data/shapefiles/municipalites/municipalities.shp").absolute()
...
municipalities.to_file(out_shapefile_path, driver="ESRI Shapefile")
